...
const styles = StyleSheet.create({
  ...
  headerBtnText: { fontWeight: "900", color: theme.text, fontSize: 12 },
  ...
  statLabel: { fontSize: 11, fontWeight: "900", color: theme.muted },
  statValue: { marginTop: 3, fontSize: 13, fontWeight: "900", color: theme.text },

  todayRow: { flexDirection: "row", alignItems: "center", gap: 12, marginTop: 10 },
  bigCheck: {
    width: 34,
    height: 34,
    borderRadius: 17,
  ...
  bigCheckText: { fontWeight: "900", color: theme.text },

  warnBox: { marginTop: 12, backgroundColor: theme.dangerBg, borderRadius: theme.radius, padding: 12 },
  ...
  actionText: { color: theme.bg, fontWeight: "900", fontSize: 13 },
  ...
  smallBtnText: { fontWeight: "900", color: theme.text, fontSize: 12 },
  ...
  checkRowOn: { backgroundColor: theme.accent },
  checkBox: {
    width: 22,
    height: 22,
    borderRadius: 6,
  ...
  modalWarn: { marginTop: 8, fontWeight: "900", color: theme.dangerText, fontSize: 12 },
});